    ...
    <div id="page-wrapper">
      ...
      <!-- CHOOSE COURSES-->
                <div class="section section-padding choose-course">
                    <div class="container">
                        <div class="group-title-index"><h4 class="top-title">Some Popular Schools  </h4>

                            <h2 class="center-title">SEE THE SCHOOL & EDUCATED TEACHERS</h2>
                            ...
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-1">
                                    <div class="icon-circle">
                                        ...
                                        <div class="info">
                                            <div class="info-back"><a href="courses.html">Happy Palace</a></div>
                                        </div>
                                    </div>
                                    <div class="name-course"><a href="courses.html">School 1</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-2">
                                    <div class="icon-circle">
                                        ...
                                        <div class="info">
                                            <div class="info-back"><a href="courses.html">Metropolitan</a></div>
                                        </div>
                                    </div>
                                    <div class="name-course"><a href="courses.html">School 2</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-3">
                                    <div class="icon-circle">
                                        ...
                                        <div class="info">
                                            <div class="info-back"><a href="courses.html">habib Public</a></div>
                                        </div>
                                    </div>
                                    <div class="name-course"><a href="courses.html">School 3</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-4">
                                    <div class="icon-circle">
                                        ...
                                        <div class="info">
                                            <div class="info-back"><a href="courses.html">The Educaters</a></div>
                                        </div>
                                    </div>
                                    <div class="name-course"><a href="courses.html">School 4</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-5">
                                    <div class="icon-circle">
                                        ...
                                        <div class="info">
                                            <div class="info-back"><a href="courses.html">Bechon House</a></div>
                                        </div>
                                    </div>
                                    <div class="name-course"><a href="courses.html">School 5</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                            <div class="col-md-4 col-xs-6">
                                <div class="item-course item-6">
                                    <div class="icon-circle">
                                        ...
                                        <div class="info">
                                            <div class="info-back"><a href="courses.html">Shah Grammer</a></div>
                                        </div>
                                    </div>
                                    <div class="name-course"><a href="courses.html">School 6</a><i class="fa fa-long-arrow-right"></i></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- PROGRESS BARS-->
                <div class="section progress-bars section-padding">
                    <div class="container">
                        <div class="progress-bars-content">
                            <div class="progress-bar-wrapper"><h2 class="title-2">  Traffic&nbsp; In &nbsp;Our&nbsp; Site  </h2>

                                <div class="row">
                                    <div class="content">
                                        <div class="col-sm-3">
                                            <div class="progress-bar-number">
                                                <div data-from="0" data-to="45" data-speed="1000" class="num">05</div>
                                                <p class="name-inner">schools</p></div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="progress-bar-number">
                                                <div data-from="0" data-to="56" data-speed="1000" class="num">50</div>
                                                <p class="name-inner">Teachers</p></div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="progress-bar-number">
                                                <div data-from="0" data-to="165" data-speed="1000" class="num">100</div>
     ...
     <!-- TOP COURSES-->
                <div class="section section-padding top-courses">
                    <div class="container">
                        <div class="group-title-index"><h4 class="top-title">CHOOSE YOUR Desire School</h4>

                            <h2 class="center-title">Some School Awaiting For Your Rating</h2>
                                ...
                                <div class="top-courses-item">
                                    <div class="edugate-layout-2">
                                        <div class="edugate-layout-2-wrapper">
                                            <div class="edugate-content"><a href="courses-detail.html" class="title">school name</a>

                                                <div class="info">
                                                    <div class="author item"><a href="#">principal name</a></div>
                                                ...
                                                <div class="description">discription of schools</div>
                                                <button onclick="window.location.href='courses-detail.html'" class="btn btn-green"><span>learn more</span></button>
                                            </div>
                                    ...
                                    <div class="edugate-layout-2">
                                        <div class="edugate-layout-2-wrapper">
                                            <div class="edugate-content"><a href="courses-detail.html" class="title">school name</a>
                                                ...
                                                <div class="description">discription of school</div>
                            ...
                            <div role="listbox" class="slider-talk-about-us-content carousel-inner">
                                <div class="peopel-item item active"><p class="peopel-comment">" There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. "</p>
                                    ...
                                    <div class="group-peole-info">
                                        ...
                                        <div class="peopel-name">shaheryar & siddique</div>
                                        <div class="people-job">3rd in graduation</div>
                                    </div>
                                </div>
                                <div class="peopel-item item"><p class="peopel-comment">" There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. "</p>
                                    ...
                                    <div class="group-peole-info">
                                        <div class="peopel-avatar"><img src="assets/images/people-avatar-1.jpg" alt="" class="img-responsive"/></div>
                                        <div class="peopel-name">M shahwaiz hasan</div>
                                        <div class="people-job">top in graduation</div>
                                    </div>
                                </div>
                                <div class="peopel-item item"><p class="peopel-comment">" There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. "</p>
                                    ...
                                    <div class="group-peole-info">
                                        <div class="peopel-avatar"><img src="assets/images/people-avatar-1.jpg" alt="" class="img-responsive"/></div>
                                        <div class="peopel-name">jahangeer & ahmed</div>
                                        <div class="people-job">2nd in graduation</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="section section-padding latest-news">
                    <div class="container">
                        <div class="group-title-index"><h4 class="top-title">latest news</h4>
                            ...
                            <h2 class="center-title">TOP POPULAR NEWS FOR YOU</h2>
                        ...
                        <div class="latest-news-wrapper">
                            <div class="edugate-layout-1">
                                ...
                                <div class="edugate-content"><a href="news-detail.html" class="title">NEWS</a>
                                    ...
                                    <button onclick="window.location.href='news-detail.html'" class="btn btn-green"><span>learn more</span></button>
                                </div>
                            </div>
                            <div class="edugate-layout-1">
                            ...
                            <button class="btn btn-green btn-latest-new"><span>Check All News<i class="fa fa-long-arrow-right"></i></span></button>
                        </div>
                    </div>
                </div>
      <!-- BEST STAFF-->
